 ...
 *
 * @see <a href="https://www.baeldung.com/deeplearning4j">A Guide to Deeplearning4j</a>
 */
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    try (RecordReader recordReader = new CSVRecordReader(0, ',')) {
      ...
      DataSetIterator iterator =
          new RecordReaderDataSetIterator(recordReader, 150, FEATURE_COUNT, CLASSES_COUNT);
